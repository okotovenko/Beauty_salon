(() => {
    ...
    function sortForTabs() {
        let worksButton = document.querySelectorAll(".works__button");
        let worksItem = document.querySelectorAll(".works__item-ibg");
    ...
    function playVideoForYouTube() {
        var vid = document.querySelectorAll("#myVideo");
